...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="assets/signal-dark.svg?v=56fe4908b5">
  <source media="(prefers-color-scheme: light)" srcset="assets/signal-light.svg?v=014f90b11d">
  <img alt="Language breakdown by bytes across public repositories, above the working stack." src="assets/signal-dark.svg?v=56fe4908b5" width="100%">
</picture>
